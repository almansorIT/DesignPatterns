...
// The opaque façade implementation
public class ECommerceFacade : IECommerceOpaqueFacade
{
    ...
    internal ECommerceFacade(InventoryService inventoryService,
    OrderProcessingService orderProcessingService, ShippingService shippingService)
    {
